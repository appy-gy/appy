...
Rails.application.config.sorcery.submodules = [:reset_password, :session_timeout, :external]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.not_authenticated_action = :access_denied
